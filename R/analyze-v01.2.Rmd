...
(or, as I like to see it, make my code more efficient), we cab create a 
...
I write a basic function so I can use it twice. (Hooray for functions!)
...
[International Baccalaureate](www.ibo.org/) (IB) which has a high school program for 
that is analogous to the 
[Advanced Placement](https://apstudent.collegeboard.org/apcourse) (AP) program that United States
high school students are probably familiar with. After participating in the IB program
in high school, it evident that my interest in it dropped off.
...
For this analysis,
we'll treat the years of search history as document.
...
a degree in Electrical Engineering. Words such as `integral`, `ut`, `socket`, `neutron`, reflect
